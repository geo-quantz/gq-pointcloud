...
# macOS Build Script for PDAL Filter CLI

echo "Starting macOS build process..."

# 1. Setup environment
PYTHON_EXE=${PYTHON_EXE:-python3}
VENV_DIR="build_venv_macos"
...
pyinstaller --clean packaging/pdal_filter_macos.spec
...
cd dist
zip -r pdal_filter_macos.zip pdal_filter
cd ..
echo "Archive created: dist/pdal_filter_macos.zip"
